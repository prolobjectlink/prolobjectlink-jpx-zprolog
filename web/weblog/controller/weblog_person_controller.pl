...
weblog_person_update(LASTNAME, ADDRESS, SALT, IDNUMBER, PHOTO, FIRSTNAME, PHONE, MIDDLENAME, COMPANY, ID, PWD, USER, EMAIL, ENTITY) :- 
	integer_parse_int(ID, A),
	weblog_person_retrieve_one(A, ENTITY),
...
weblog_person_create(LASTNAME, ADDRESS, SALT, IDNUMBER, PHOTO, FIRSTNAME, PHONE, MIDDLENAME, COMPANY, PWD, USER, EMAIL, ENTITY) :- 
